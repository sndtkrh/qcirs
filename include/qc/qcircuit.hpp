...
typedef std::vector<comp> Qstate;
  ...
  public:
    ...
    */
    ...
    void run();
    std::vector<double> measure(const std::vector<qbitsize> & computational_basis);
    std::vector<double> measure_change_state_deterministically(const std::vector<qbitsize> & computational_basis);
    std::vector<double> measure_change_state_randomly(const std::vector<qbitsize> & computational_basis);
